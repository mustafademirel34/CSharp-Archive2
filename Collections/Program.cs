...
namespace Collections
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // verilen bilginin değerini döndürür
        ...
        private static void List()
        {
            ...
            // kaçıncı sekmede olduğunu verir
            ...
            // istenilen sekmeye konur
            customers.Insert(0, customer2);

            // verilen nesneyi ilk bulduğunu siler
            //customers.Remove(customer2);
            //customers.Remove(customer2);
            //customers.Remove(customer2);

            // verilen nesneye benzer hepsini siler
