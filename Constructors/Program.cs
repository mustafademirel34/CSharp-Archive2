...
namespace Constructors
{
    ...
    /*
    Destructor kısaca constructor'ın tam tersidir.Constructor için bir nesnenin instance'ı 
    alınırken Ram'de ki Heap bölümünde yer ayırmadan önce çağrılan metod diyebiliriz. 
    Destructor tam bu nesne ram'den silinmeden önce çağrılan metod dur.
    ...
    class PersonManager:BaseClass
    {
        ...
        {
            // bu şekilde base class'a değer gönderebiliriz.
            // ve bu şekilde classlarımızın inherit edildiği noktalarda istekte bulunabiliriz.
        }
